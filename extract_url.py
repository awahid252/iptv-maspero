...
def create_m3u(stream_url):
    ...
    # Clean any backslashes or encoded slashes out of the URL string
    stream_url = stream_url.replace('\\', '')

    # Strict Smart IPTV parsing layout using single quotes and trailing newline control
    m3u_content = (
        "#EXTM3U\n"
    ...
    try:
        # Explicitly writing with newline character settings to prevent OS carriage errors
